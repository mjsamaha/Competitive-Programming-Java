...
public class Word {
	...
	static void solve() throws Exception {
		...
		for (char ch : s1.toCharArray()) { // single pass, iterate the string, check each character, if lc ++ lccount, else ++ ucount
		...
		// logic, if counts are equal - toLowerCase --- if lcount > ucount --> toLowerCase ---- else toUpperCase
