...
public class Petya_Strings {
	...
	static void solve() throws Exception {
		...
		/**
		 * compare each i characters in alpha order
		 * 
		 * if s1 < s2 = -1
		 * 
		 * if s2 < s1 = 1
		...
		String s1 = nextString().toLowerCase();
		String s2 = nextString().toLowerCase();
		
		int res = s1.compareTo(s2); // compares in dict order, checking characters one at a time (left to right)
